    ...
    return (
      <View style={{flex: 1, backgroundColor: '#E5E5E5'}}>
        <View style={{marginHorizontal: 17, flexDirection: 'row', paddingTop: 30}}>
          <View>
            <Text style={{fontWeight: 'bold', fontSize: 28, color: '#526EDD'}}>Home</Text>
          </View>
        ...
        <ScrollView>
        <View style={{flex: 0, flexDirection: 'row', marginTop: 20, paddingBottom: 10, borderRadius: 15, marginHorizontal: 17, backgroundColor: '#50A5D3'}}>
          <Image source={require('../src/image/Prof1.png')} style={{margin: 13}}/>
          <View style={{marginLeft: 30, marginTop: 10}}>
            <Text style={{fontSize: 20, fontWeight: 'bold', color: 'white'}}>Hello, Hendrik Krisma!</Text>
            <Text style={{fontSize: 16, marginTop: 10, color: 'white'}}>Tuesday, 11 November 2019</Text>
          </View>
        </View>
        <View style={{flex: 0, marginHorizontal: 17, marginTop: 30}}>
          <Text style={{fontSize: 16, fontWeight: 'bold', marginBottom: 8}}>Event you might like</Text>
          <ScrollView horizontal={true} style={{flexDirection: 'row'}}>
            <View style={{marginRight: 18,height:230 , width: 183, backgroundColor: 'white', borderRadius: 15, alignItems: 'center', justifyContent: 'center'}}>
              ...
              <View style={{flexDirection: 'row', flex: 0, justifyContent: 'center'}}>
                ...
                <Text style={{fontSize: 9, color: 'gray'}}>Jl. Gajah Mada, Pontianak</Text>
              </View>
              <View style={{flexDirection: 'row', marginHorizontal: 10, marginTop: 4}}>
                <View style={{flex: 1,height:40, width: 80}}>
                  <Text style={{color: 'gray', fontSize: 11}}>Distance</Text>
                  <Text style={{fontSize: 12, fontWeight: 'bold'}}>524 meters</Text>
                </View>
                <View style={{flex: 1,height: 40, width: 80}}>
                  <Text style={{color: 'gray', fontSize: 11}}>People Join</Text>
                  <Text style={{fontSize: 12, fontWeight: 'bold'}}>10,000 people</Text>
                </View>
              </View>
              <View style={{flexDirection: 'row', marginHorizontal: 10, justifyContent: 'space-between', alignItems: 'center'}}>
                <TouchableOpacity onPress={this._onPressButton} style={{width: 70, height: 30, backgroundColor: '#50A5D3', marginRight: 18, borderRadius: 4}}>
                    <Text style={{textAlign: 'center', marginTop: 5, fontSize: 12, fontWeight: 'bold', color: 'white'}}>Join Now</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                  <Text style={{fontSize: 11, color: 'gray', marginRight: 10}}>View More</Text>
                </TouchableOpacity>
              </View>
            </View>
            <View style={{marginRight: 18, height:230 , width: 183, backgroundColor: 'white', borderRadius: 15, alignItems: 'center', justifyContent: 'center'}}>
        ...
        <View style={{flex: 1, marginHorizontal: 17, marginTop: 40}}>
          <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15}}>
            <Text style={{fontSize: 16, fontWeight: 'bold'}}>May You Like Community</Text>
            <TouchableOpacity>
              <Text style={{color: '#526EDD', fontWeight: 'bold'}}>Show All</Text>
            </TouchableOpacity>
          </View>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View style={{height: 103, width: 55, backgroundColor: '#576EC9', borderRadius: 50, marginRight: 10, justifyContent: 'center', alignItems: 'center'}}>
              <TouchableOpacity>
        ...
        <View style={{backgroundColor: 'white', flexDirection: 'row', height: 54}}>
          ...
          <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            <TouchableOpacity onPress={()=> this.props.navigation.navigate('homeScreen')}>
              <Image source={require('../src/image/Home-Active.png')} styles={{width: 20, height: 20}}/>
            </TouchableOpacity>
          </View>
          <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
